...
That is the entire setup. The widgets are built on [shadcn/ui](https://ui.shadcn.com) + Radix, and every rule in the stylesheet is scoped to the widgets' own root element — it cannot restyle your pages, and you do not need Tailwind (or any particular build setup) to use it.
